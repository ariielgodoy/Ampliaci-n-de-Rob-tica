    ...
    */
    ...
    private:
        ...
        Eigen::VectorXd impedance_controller()
        {
            ...
            Eigen::VectorXd x_error = Eigen::VectorXd::Zero(2);
            Eigen::VectorXd x_dot_error = Eigen::VectorXd::Zero(2);
            ...
            x_ddot<< (mass_matrix_.inverse())*(cartesian_pose_ - (stiffness_matrix_*x_error)-(damping_matrix_*x_dot_error));
        ...
        Eigen::VectorXd calculate_desired_joint_accelerations()
        {
            ...
            // q'' = J(q)^(-1)[x'' - J'(q,q')q']
            Eigen::VectorXd q_ddot = Eigen::VectorXd::Zero(2);
